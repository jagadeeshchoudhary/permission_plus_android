...
class PermissionStatusMapEntry {
  ...
  bool operator ==(Object other) {
    if (other is! PermissionStatusMapEntry ||
...
class PermissionPlusHostApi {
  ...
  Future<PermissionStatusMessage> checkPermission(
    ...
    final pigeonVar_channelName =
        'dev.flutter.pigeon.permission_plus_android.PermissionPlusHostApi.checkPermission$pigeonVar_messageChannelSuffix';
  ...
  Future<PermissionStatusMessage> requestPermission(
    ...
    final pigeonVar_channelName =
        'dev.flutter.pigeon.permission_plus_android.PermissionPlusHostApi.requestPermission$pigeonVar_messageChannelSuffix';
    final pigeonVar_channel = BasicMessageChannel<Object?>(
      pigeonVar_channelName,
      pigeonChannelCodec,
      binaryMessenger: pigeonVar_binaryMessenger,
  ...
  Future<List<PermissionStatusMapEntry>> requestPermissions(
    ...
    final pigeonVar_channelName =
        'dev.flutter.pigeon.permission_plus_android.PermissionPlusHostApi.requestPermissions$pigeonVar_messageChannelSuffix';
    final pigeonVar_channel = BasicMessageChannel<Object?>(
      pigeonVar_channelName,
      pigeonChannelCodec,
      binaryMessenger: pigeonVar_binaryMessenger,
    ...
    return (pigeonVar_replyValue! as List<Object?>)
        .cast<PermissionStatusMapEntry>();
  }

  /// Opens the platform's app settings page.
  Future<bool> openSettings() async {
    final pigeonVar_channelName =
        'dev.flutter.pigeon.permission_plus_android.PermissionPlusHostApi.openSettings$pigeonVar_messageChannelSuffix';
    final pigeonVar_channel = BasicMessageChannel<Object?>(
      pigeonVar_channelName,
      pigeonChannelCodec,
      binaryMessenger: pigeonVar_binaryMessenger,
  ...
  Future<bool> shouldShowRationale(PermissionTypeMessage permission) async {
    final pigeonVar_channelName =
        'dev.flutter.pigeon.permission_plus_android.PermissionPlusHostApi.shouldShowRationale$pigeonVar_messageChannelSuffix';
    final pigeonVar_channel = BasicMessageChannel<Object?>(
      pigeonVar_channelName,
      pigeonChannelCodec,
      binaryMessenger: pigeonVar_binaryMessenger,
  ...
  Future<LocationAccuracyMessage> getLocationAccuracy() async {
    final pigeonVar_channelName =
        'dev.flutter.pigeon.permission_plus_android.PermissionPlusHostApi.getLocationAccuracy$pigeonVar_messageChannelSuffix';
    final pigeonVar_channel = BasicMessageChannel<Object?>(
      pigeonVar_channelName,
      pigeonChannelCodec,
      binaryMessenger: pigeonVar_binaryMessenger,
  ...
  Future<PermissionStatusMessage> requestTemporaryPreciseLocation(
    ...
    final pigeonVar_channelName =
        'dev.flutter.pigeon.permission_plus_android.PermissionPlusHostApi.requestTemporaryPreciseLocation$pigeonVar_messageChannelSuffix';
    final pigeonVar_channel = BasicMessageChannel<Object?>(
      pigeonVar_channelName,
      pigeonChannelCodec,
      binaryMessenger: pigeonVar_binaryMessenger,
